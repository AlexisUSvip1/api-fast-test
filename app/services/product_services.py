...
class ProductService:
    @staticmethod
    async def get_products(db: AsyncSession, search: str | None = None, offset: int = 0, limit: int = 10) -> dict:
        return await ProductRepository.get_all(db, search=search, offset=offset, limit=limit)
